...
### First steps in Coolify, 5min to deploy your world!
...
4. in 'General', Change 'Build Pack' to 'Dockerfile' (hyperfy on github has a docker file ready to be used)
5. Enter the URL of the domain name the world points to (optional but recommended, Coolify should already provide a URL by default based on your setup)
6. Enter the following in 'Environment Variables' section (variables to be entered one by one as 'Name' = 'Value'):
- JWT_SECRET=hyper
- PORT=3000
...
- SAVE_INTERVAL=60
- WORLD=world
7. still in the 'Configuration' section of the resource, create a volume in 'Persistent Storage' where
Source Path is '/' and
Destination Path is '/app/world'
8. last step, press the 'Deploy' button near the top right of the page (crossing fingers is optional :)
9. Go and check your brand new hyperfied world using the URL used in 4.
